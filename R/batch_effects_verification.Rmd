...
To start with, let us construct a dimensional reduction plot with the three conditions we have: healthy, ulcerative colitis, and Crohn's disease. 
...
To conclude, given that each cell type contains all three conditions and all 18 patients, batch effects can be ignored in the previously completed clustering and annotating step. Thus, we move onto studying GCNT2's expression profile without repeating the above-mentioned step.
