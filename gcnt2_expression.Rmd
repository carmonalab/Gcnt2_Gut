...
We extract the GCNT2 normalized counts and add them as a meta data column in our Seurat object for easier manipulation in downstream analyses.
...
Seemingly, GCNT2 is expressed by very few cells in our Seurat object. Let us quantify the number and percentage of cells, within our Seurat object, that express GCNT2.
...
signif.plot(cmc@meta.data, x = "Treatment", y = "GCNT2", 
            ...
            plot_title = "GCNT2 Expression vs. Gut Condition, Tukey HSD Testd")
```
...
for(cell_type in cell_types){
  ...
  if(length(un_rep_conditions) < length(unique(cell_type_meta$Treatment))) {
    ...
    print(signif.plot(cell_type_meta, x = "Treatment", y = "GCNT2", plot_type = "Boxplot",
                      test = "Tukey", plot_title = cell_type))
  }
}
```
