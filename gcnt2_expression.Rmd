...
gcnt2.wilcox.results <- purrr::map_dfr(groups, 
                                       ~multiple.wilcox.tests(gcnt2.cell_type.expression, 
                                                              "manual_annotation", 
                                                              "GCNT2", 
                                                              .x))
...
conditions <- unique(gcnt2.condition.expression$Treatement)
groups <- combn(conditions, 2, simplify = FALSE)
gcnt2.wilcox.results <- purrr::map_dfr(groups, 
                                       ~multiple.wilcox.tests(gcnt2.condition.expression, 
                                                              "Treatment", 
                                                              "GCNT2", 
                                                              .x))
print(gcnt2.wilcox.results)
